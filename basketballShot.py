...
class BasketballShot:
    def __init__(self, shot_start_x, shot_start_y, shot_id, play_description, shot_made, team,quarter,time,realquarter,typeshotchart,misspath,makepath,realquarter):
        self.hoop_loc_x = 25
    ...
    def __calculate_shot_height(self):
        ...
        if self.shot_distance >= 43:
            self.shot_vertex_z = 17.5
        elif self.shot_distance >= 38:
            self.shot_vertex_z = 16.5
        elif self.shot_distance >= 33:
             self.shot_vertex_z = 15.5
        elif self.shot_distance >= 28:
            self.shot_vertex_z = 14.5
    ...
    def get_shot_path_coordinates(self) -> pd.DataFrame:
        ...
        self.shot_path_coordinates_df['realquarter'] = self.realquarter
