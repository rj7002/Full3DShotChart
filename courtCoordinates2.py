...
class CourtCoordinates2:
    ...
    def __init__(self,year):
        ...
        self.hoop_radius = .75
        if year >= 2013:
            self.three_arc_distance = 22.145  # 22 feet 1.75 inches
            self.three_straight_distance = 21.666  # 21 feet 8 inches
            self.three_straight_length = 8.89  # 8 feet 10.75 inches
        else:
            self.three_arc_distance = 20.520  # Example value for 2023
            self.three_straight_distance = 20  # Example value for 2023
            self.three_straight_length = 8.5  # Example value for 2023
        # self.three_arc_distance = 22.145      # the NCAA men's three-point arc is 22ft and 1.75in from the hoop center
        # self.three_straight_distance = 21.666      # the NCAA men's three-point straight section is 21ft 8in from the hoop center
