...
st.write(
    'Enter a game ID to view the 3D shot chart. Leagues such as the [NBL](https://nbl.com.au) and the [TBL](https://thebasketballleague.net/) along with games on FIBA LiveStats are available to view.'
)
...
# Create the DataFrame
    ...
    required_columns = [
    'score', 'full_score', 'tot_sMinutes', 'tot_sFieldGoalsMade',
    'tot_sFieldGoalsAttempted', 'tot_sFieldGoalsPercentage', 
    'tot_sThreePointersMade', 'tot_sThreePointersAttempted', 
    'tot_sThreePointersPercentage', 'tot_sTwoPointersMade', 
    'tot_sTwoPointersAttempted', 'tot_sTwoPointersPercentage', 
    'tot_sFreeThrowsMade', 'tot_sFreeThrowsAttempted', 
    'tot_sFreeThrowsPercentage', 'tot_sReboundsDefensive', 
    'tot_sReboundsOffensive', 'tot_sReboundsTotal', 'tot_sAssists', 
    'tot_sTurnovers', 'tot_sSteals', 'tot_sBlocks', 'tot_sFoulsOn', 
    'tot_sFoulsTotal', 'tot_sPoints', 'tot_sPointsFromTurnovers', 
    'tot_sPointsSecondChance', 'tot_sPointsFastBreak', 
    'tot_sBenchPoints', 'tot_sPointsInThePaint', 
    'tot_sFoulsTeam', 'tot_sReboundsTeam', 
    'tot_sReboundsTeamDefensive', 'tot_sReboundsTeamOffensive', 
    'tot_sTurnoversTeam'
]

    # # Find common columns in both DataFrames
    # common_columns = [col for col in required_columns if col in teamdf.columns and col in teamdf2.columns]
    
    # # Create filtered_data and filtered_data2 based on common columns
    # filtered_data = {col: teamdf[col] for col in common_columns}
    # filtered_data2 = {col: teamdf2[col] for col in common_columns}
...
def create_pitch_3d():
    ...
    num_net_lines = 20
    net_length = 1.5  # Net length in cm
