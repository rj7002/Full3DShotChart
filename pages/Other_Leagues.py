...
st.write(
    'Enter a game ID to view the 3D shot chart. Leagues such as the [NBL](https://nbl.com.au) and the [TBL](https://thebasketballleague.com.au) along with some FIBA games are available to view.'
)
