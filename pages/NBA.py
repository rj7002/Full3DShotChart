...
if selected_season:
    ...
    # Get unique players
        ...
        # Convert to datetime object
                        ...
                        playerdict = players.find_players_by_full_name(player_name)
                        ...
                        col1,col2, = st.columns(2)
                        with col1:
                            display_player_image(playerid,400,f"{playerdata['DISPLAY_FIRST_LAST'].iloc[0]}")
