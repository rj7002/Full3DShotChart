...
class CourtCoordinates:
    ...
    def __init__(self,type,year):
        if type == 'MBB':
            if year <= 2019:
                self.three_arc_distance = 20.75       
                self.three_straight_distance = 20.25  
                self.three_straight_length = 8.89      # the NCAA men's three-point straight section length is 8ft and 10.75in
            else:
                self.three_arc_distance = 22.145       
                self.three_straight_distance = 21.666
                self.three_straight_length = 8.89      # the NCAA men's three-point straight section length is 8ft and 10.75in
        elif type == 'WBB':
            if year <= 2021:
                self.three_arc_distance = 20.75       
                self.three_straight_distance = 20.25
                self.three_straight_length = 8.5      # the NCAA men's three-point straight section length is 8ft and 10.75in
            else:
                self.three_arc_distance = 22.145       
                self.three_straight_distance = 21.666
                self.three_straight_length = 8.89      # the NCAA men's three-point straight section length is 8ft and 10.75in
